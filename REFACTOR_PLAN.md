...
- [ ] Passo 14 — Criação de despesas → `createExpense()` único (item 9) — **saltado, ver nota abaixo**. Corrigido só o bug do P3 (data de início do fundo de maneio), commit feito.
- [ ] Passo 15 — Criação de receitas → `createIncome()` único (item 10)
